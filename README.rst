...
PS. your commands are loaded from the modules used in the application, you can implement them, see :filename: :./logos_cdi/command.py: file to understand how to create a module.
